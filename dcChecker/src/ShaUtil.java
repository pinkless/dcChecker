...
public class ShaUtil {
    ...
    public static byte[] getSHA1(byte[] painText, boolean uppercase) {
        return getSha(painText, SHA_1, uppercase);
    }

    public static byte[] getSHA224(byte[] painText, boolean uppercase) {
        return getSha(painText, SHA_224, uppercase);
    }

    public static byte[] getSHA256(byte[] painText, boolean uppercase) {
        return getSha(painText, SHA_256, uppercase);
    }

    public static byte[] getSHA384(byte[] painText, boolean uppercase) {
        return getSha(painText, SHA_384, uppercase);
    }

    public static byte[] getSHA512(byte[] painText, boolean uppercase) {
     ...
     * @return
     */
    private static byte[] getSha(byte[] plainText, String algorithm, boolean uppercase) {
        //输入的字符串转换成字节数组
        byte[] bytes = plainText;  //字节类型
//   String类型     byte[] bytes = plainText.getBytes(StandardCharsets.UTF_8);
